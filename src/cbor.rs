...
pub struct LpCbor<Req, Resp, Protocol> {
    phantom: PhantomData<(Req, Resp, Protocol)>,
}

impl<Req, Resp, Protocol> Default for LpCbor<Req, Resp, Protocol> {
    fn default() -> Self {
        Self {
            phantom: PhantomData,
        }
...
impl<Req, Resp, Protocol> Clone for LpCbor<Req, Resp, Protocol> {
    fn clone(&self) -> Self {
        Self::default()
    }
}
...
impl<Req, Resp, Protocol> Codec for LpCbor<Req, Resp, Protocol>
where
